import { createWidgetState, EventNames, Helpers, WidgetClient, WidgetState, WidgetViewSize } from "@statflo/textkit-widget-events";
import React, { createContext, useContext, useEffect, useMemo, useState } from "react";

import { TextKitContextProps, TextKitWidgetProviderProps, TextKitWidgetState } from "./types";
...
export function TextKitWidgetProvider({ footer, header, label, children, scrollOverride = false, render }: TextKitWidgetProviderProps) {
